...
class ChampionMasteryConnection : Connection {
    ...
    constructor(host: String) {
        ...
        this.URL_TOTAL_MASTERY_SCORE = "https://" + HOST + GlobalState.PATH_CHAMPION_MASTERY_V3 + "champion-masteries/"
     ...
     */
    public fun getCampMasteryList(summonerId: Long, apiKey: String): List<ChampionMasteryDTO> {
     ...
     */
    public fun getCampMastery(summonerId: Long, championId: Long, apiKey: String): ChampionMasteryDTO {
    ...
    public fun getTotalMasteryScore(summonerId: Long, apiKey: String): Int {
        var responde = connectAPI(URL_TOTAL_MASTERY_SCORE + summonerId + PARAM_API_KEY + apiKey)
        var score : Int = -1
        if(responde.isNotEmpty()){
